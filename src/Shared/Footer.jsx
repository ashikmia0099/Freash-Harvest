...
function Footer() {
    return (
        <div className='max-w-[1440px] mx-auto   '>
            <div className='grid grid-cols-5 bg-[#F4F6F6] px-28 pt-16'>
                {/* logo seciton */}
                <div className=' col-span-2'>
                    {/* logo section */}
                    <div className=' flex items-center gap-2'>
                        <Image src={logo} className=' w-[52] h-[52]'></Image>
                        <h4 className=' text-3xl font-bold text-[#212337]'>Fresh Harvest</h4>
                    </div>
                ...
                <div className=' col-span-1'>
                    <div>
                        <h4 className='text-lg font-medium text-[#212337] pb-3'>Quick links 1</h4>
                    </div>
                    <div>
                ...
                <div className=' col-span-1'>
                    <div>
                        <h4 className='text-lg font-medium text-[#212337] pb-3'>Quick links 2</h4>
                    </div>
                    <div>
                        <ul className=' space-y-1.5'>
                ...
                <div className=' col-span-1'>
                    <div>
                        <h4 className='text-lg font-medium text-[#212337] pb-3'>Contact us</h4>
                    </div>
                    <div>
                        <ul className=' space-y-1.5 pb-8'>
                            ...
                            <li className=' text-sm text-[#4A4A52] flex items-center gap-2'> <span className='text-[#749B3F]'><MdOutlineMail /></span> Freshharvests@gmail.com</li>
                            <li className=' text-sm text-[#4A4A52] flex items-center gap-2'> <span className='text-[#749B3F]'><FaLocationDot /></span> Tanjung Sari Street, Pontianak, Indonesia</li>
            ...
            <div className=' bg-[#F4F6F6] px-28 pt-5 pb-5'>
                <p className=' border-t-2 border-[#D9D9D9]'></p>
                <div className=' flex justify-between items-center pt-6'>
                    <div>
                        <p className=' text-[#212337] text-[12px] font-bold '>© Copyright 2024, All Rights Reserved by Banana Studio</p>
                    </div>
